            ...
            >
                ...
                <details className='collapse bg-base-200'>
                  ...
                  <div className='collapse-content'>
                    <p className='text-lg'>
                      ...
                      transition happen from that position to its opposite in
                      the screen. <br></br>'none' is an alias to 'simple' that
                      also sets the 'transition-step' to 255, this has the
                      effect of the transition finishing instantly. <br></br>{' '}
                      'fade' is similar to 'simple' but the fade is controlled
                      through the --transition-bezier flag.<br></br> 'wipe' is
                      similar to 'left' but allows you to specify the angle for
                      transition with the `--transition-angle` flag.<br></br>{' '}
                      'wave' is similar to 'wipe' sweeping line is wavy.
                      <br></br> 'grow' causes a growing circle to transition
                      across the screen and allows changing the circle's center
                      position with the `--transition-pos` flag. <br></br>
                      'center' is an alias to 'grow' with position set to center
                      of screen.<br></br> 'any' is an alias to 'grow' with
                      position set to a random point on screen. 'outer' is the
                      same as grow but the circle shrinks instead of growing.
                      Finally, 'random' will select a transition effect at
                      random
                    </p>
                  </div>
                </details>
              ...
              <div className='mt-6'>
                ...
                <label htmlFor='' className='label'>
                  <span className='label-text text-lg'>
                    How long the transition takes to complete in seconds. Note
                    that this doesn't work with the 'simple' transition
                  </span>
                </label>
                <input
                  type='number'
              ...
              <div className='mt-6'>
                ...
                <label htmlFor='' className='label'>
                  <span className=' label-text text-lg'>
                    This is used for 'wipe' and 'wave' transitions. It controls
              ...
              <div className='mt-6 '>
                ...
                <label htmlFor='transitionPosition' className='label'>
                  <span className='text-lg label-text '>
                    ...
                    controls the center of the circle. Default is center.
                    Position values can be given in both percentage values and
                    pixel values: float values are interpreted as percentages
                    and integer values as pixel values eg: 0.5,0.5 means 50% of
                    the screen width and 50% of the screen height 200,400 means
                    200 pixels from the left and 400 pixels from the bottom
                  </span>
                </label>
                <select
