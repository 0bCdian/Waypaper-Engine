					...
					<div className="flex max-h-[75vh] min-h-0 w-full flex-col items-center justify-between overflow-y-scroll scrollbar-thin scrollbar-track-base-100 scrollbar-thumb-stone-300">
						...
						>
							...
							<div className="my-4">
								...
								<h2 className="mt-6 text-3xl">Transition Type</h2>
								...
								<details className="collapse bg-base-200">
									...
									<div className="collapse-content">
										<p className="text-lg">
											...
											the screen. <br></br>none is an alias to simple that also
											sets the transition-step to 255, this has the effect of
											the transition finishing instantly. <br></br> fade is
											similar to simple but the fade is controlled through the
											--transition-bezier flag.
											<br></br> wipe is similar to left but allows you to
											specify the angle for transition with the
											`--transition-angle` flag.<br></br> wave is similar to
											wipe sweeping line is wavy.
											<br></br> grow causes a growing circle to transition
											across the screen and allows changing the circle&aposs
											center position with the `--transition-pos` flag.{" "}
											<br></br>
							...
							<div className="mt-6">
								...
								<label htmlFor="" className="label">
									<span className="label-text text-lg">
										...
										that this does not work with the simple transition
									</span>
								</label>
								<input
									type="number"
							...
							<div>
								<h2 className="mt-6 text-3xl">Transition Fps</h2>
								<label htmlFor="" className="label">
									<span className="label-text text-lg">
