...
const SwwwConfig = () => {
    ...
    const [bezier, setBezier] = useState<[number, number, number, number]>([0.25, 1, 0.25, 1]);
    const onSubmit = (data: SwwwFormData) => {
        if (saveConfigTimeout !== null) {
            clearTimeout(saveConfigTimeout);
        }
        saveConfigTimeout = setTimeout(() => {
            if (data.transitionPositionFloatX === undefined || data.transitionPositionFloatY === undefined) {
                data.transitionPositionFloatX = 0.5;
                data.transitionPositionFloatY = 0.5;
            }
            if (data.transitionPositionIntY === undefined || data.transitionPositionIntY === undefined) {
        ...
        void readSwwwConfig().then((config: SwwwFormData) => {
            ...
            switch (config.transitionPositionType) {
                case 'alias':
                    ...
                    setValue('transitionPosition', config.transitionPosition as transitionPosition);
                    break;
                case 'float':
                    setValue('transitionPositionType', config.transitionPositionType);
    ...
    return (
        <>
            <AnimatePresence>
                ...
                >
                    <h1 className="text-7xl font-semibold py-2 self-center text-center">Swww Settings</h1>
                        ...
                        >
                            <div className="my-4">
                                ...
                                <label htmlFor="resizeType" className="label">
                                    <span className="label-text text-lg">Controls how the image is resized</span>
                                </label>
                                <select
                                    id="resizeType"
                            ...
                            <div className="my-4">
                                ...
                                <label htmlFor="filter" className="label">
                                    <span className="label-text text-lg">Filter to use when scaling images</span>
                                </label>
                                <select
                                    id="filter"
                                ...
                                <details className="collapse bg-base-200">
                                    ...
                                    <div className="collapse-content">
                                        <p className="text-lg">
                                            ...
                                            position to its opposite in the screen. <br></br>none is an alias to simple
                                            that also sets the transition-step to 255, this has the effect of the
                                            transition finishing instantly. <br></br> fade is similar to simple but the
                                            fade is controlled through the --transition-bezier flag.
                                            <br></br> wipe is similar to left but allows you to specify the angle for
                                            transition with the `--transition-angle` flag.<br></br> wave is similar to
                                            wipe sweeping line is wavy.
                                            <br></br> grow causes a growing circle to transition across the screen and
                                            allows changing the circle&aposs center position with the `--transition-pos`
                                            flag. <br></br>
                                            center is an alias to grow with position set to center of screen.
                                            <br></br> any is an alias to grow with position set to a random point on
                                            screen. outer is the same as grow but the circle shrinks instead of growing.
                            ...
                            <div className="mt-3">
                                ...
                                <label htmlFor="transitionStep" className="label">
                                    ...
                                    <span className="label-text-alt text-lg">{watch('transitionStep')}</span>
                                </label>
                                <input
                                    type="range"
                                    id="transitionStep"
                            ...
                            <div className="mt-6">
                                ...
                                <label htmlFor="" className="label">
                                    <span className="label-text text-lg">
                                        How long the transition takes to complete in seconds. Note that this does not
                                        work with the simple transition
                                    </span>
                                </label>
                                <input
                                    type="number"
                            ...
                            <div>
                                ...
                                <label htmlFor="" className="label">
                                    <span className="label-text text-lg">
                                        Set this to your monitor&aposs refresh rate
                                    </span>
                                </label>
                                <input
                                    type="number"
                            ...
                            <div className="mt-6">
                                ...
                                <label htmlFor="" className="label">
                                    <span className=" label-text text-lg">
                                        This is used for wipe and wave transitions. It controls the angle of the wipe
                                    </span>
                                </label>
                                <input
                                    type="number"
                            ...
                            <div className="mt-6 ">
                                ...
                                <label htmlFor="transitionPosition" className="label">
                                    <span className="text-lg label-text ">
                                        This is only used for the grow and outer transitions, it controls the center of
                                        the circle. Default is center. Position values can be given in both percentage
                                        values and pixel values: float values are interpreted as percentages and integer
                                        values as pixel values eg: 0.5,0.5 means 50% of the screen width and 50% of the
                                        screen height 200,400 means 200 pixels from the left and 400 pixels from the
                                        bottom
                                    </span>
                                </label>
                                <select
                            ...
                            <div className="mt-6 flex flex-col gap-3 items-center">
                                <div className="self-start space-y-3">
                                    ...
                                    <span className="text-lg">
                                        Control the bezier curve of the transition, insert a comma separated
                                    </span>
                                    <input
                                ...
                                <BezierCurveEditor
                                    onChange={e => {
                                        const value = e.toString() as `${number},${number},${number},${number}`;
