...
describe("calculateMinResolution", () => {
	it("calculates bounding box for single monitor", () => {
		const monitors: Monitor[] = [
			{ name: "A", width: 1920, height: 1080, x: 0, y: 0, scale: 1, refresh_rate: 60, transform: 0 },
		];
	...
	it("calculates bounding box for side-by-side monitors", () => {
		const monitors: Monitor[] = [
			{ name: "A", width: 1920, height: 1080, x: 0, y: 0, scale: 1, refresh_rate: 60, transform: 0 },
			{ name: "B", width: 2560, height: 1440, x: 1920, y: 0, scale: 1, refresh_rate: 144, transform: 0 },
		];
	...
	it("calculates bounding box for stacked monitors", () => {
		const monitors: Monitor[] = [
			{ name: "A", width: 1920, height: 1080, x: 0, y: 0, scale: 1, refresh_rate: 60, transform: 0 },
			{ name: "B", width: 1920, height: 1080, x: 0, y: 1080, scale: 1, refresh_rate: 60, transform: 0 },
		];
