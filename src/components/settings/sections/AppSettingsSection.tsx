...
export const AppSettingsSection: React.FC<AppSettingsSectionProps> = ({
  ...
  const [activeThemeTab, setActiveThemeTab] = useState<'light' | 'dark'>('dark');
    ...
    if (field.type === 'theme') {
      return (
        <div key={field.key} className="space-y-3">
          ...
          <InlineThemeSelector
            onThemeChange={(themeName) => handleValueChange(field.key, themeName)}
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="border-b border-base-300 pb-4">
        <h2 className="text-lg font-semibold text-base-content">Application Settings</h2>
        <p className="text-sm text-base-content/60 mt-1">
          Configure application behavior, appearance, and user interface preferences.
        </p>
      </div>
        ...
        <div className="collapse-content">
          <div className="pt-4">
            <div className="space-y-4">
              ...
              <InlineThemeSelector
                onThemeChange={(themeName) => handleValueChange('theme', themeName)}
