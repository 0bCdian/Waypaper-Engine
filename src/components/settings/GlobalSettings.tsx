            ...
            <div className="form-control">
              ...
              <div className="join w-full">
                <input
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, cache_dir: e.target.value }))}
      ...
      <div className="card bg-base-200">
        <div className="card-body">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-lg">Max concurrent processing</span>
              </label>
              <input
                type="number"
                className="input input-bordered w-full max-w-xs"
                value={config.max_concurrent_processing || 4}
                onChange={(e) => setConfig(prev => ({ ...prev, max_concurrent_processing: parseInt(e.target.value) }))}
                min="1"
                max="16"
                disabled={saving}
              />
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setConfig(prev => ({ ...prev, thumbnail_size: parseInt(e.target.value) }))}
                min="64"
                max="512"
                step="32"
                disabled={saving}
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setConfig(prev => ({ ...prev, image_quality: parseInt(e.target.value) }))}
                disabled={saving}
              />
      ...
      <div className="card bg-base-200">
        <div className="card-body">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-lg">Auto refresh interval (seconds)</span>
              </label>
              <input
                type="number"
                className="input input-bordered w-full max-w-xs"
                value={config.auto_refresh_interval || 30}
                onChange={(e) => setConfig(prev => ({ ...prev, auto_refresh_interval: parseInt(e.target.value) }))}
                min="5"
                max="300"
                step="5"
                disabled={saving}
