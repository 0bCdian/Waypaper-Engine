      ...
      <div className="card bg-base-200">
        <div className="card-body">
          ...
          <p className="text-base-content/70">
            Configure the swww wallpaper engine settings for smooth transitions and effects.
          </p>
          ...
          <div className="space-y-6 mt-4">
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-lg">Transition duration (ms)</span>
              </label>
              <input
                type="number"
                className="input input-bordered w-full max-w-xs"
                value={config.transition_duration || 300}
                onChange={(e) => setConfig(prev => ({ ...prev, transition_duration: parseInt(e.target.value) }))}
                min="0"
                max="5000"
                step="50"
                disabled={saving}
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setConfig(prev => ({ ...prev, transition_fps: parseInt(e.target.value) }))}
                min="1"
                max="120"
                step="1"
                disabled={saving}
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setConfig(prev => ({ ...prev, transition_angle: parseInt(e.target.value) }))}
                disabled={saving}
              />
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={(e) => saveConfig('transition_wave', e.target.checked)}
                      disabled={saving}
                    />
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={(e) => saveConfig('transition_wipe', e.target.checked)}
                      disabled={saving}
                    />
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={(e) => saveConfig('transition_grow', e.target.checked)}
                      disabled={saving}
                    />
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={(e) => saveConfig('transition_invert_y', e.target.checked)}
                      disabled={saving}
                    />
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={(e) => saveConfig('transition_invert_x', e.target.checked)}
                      disabled={saving}
                    />
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={(e) => saveConfig('transition_flip', e.target.checked)}
                      disabled={saving}
                    />
                  </label>
                </div>
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setConfig(prev => ({ ...prev, transition_bezier: e.target.value }))}
                placeholder="0,0,0,0"
                disabled={saving}
              />
              <div className="label">
