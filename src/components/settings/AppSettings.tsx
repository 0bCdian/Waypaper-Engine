      ...
      <div className="card bg-base-200">
        <div className="card-body">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text text-lg">Minimize to system tray</span>
                <input
                  type="checkbox"
                  className="toggle toggle-primary"
                  checked={config.minimize_to_tray || false}
                  onChange={(e) => saveConfig('minimize_to_tray', e.target.checked)}
                  disabled={saving}
                />
              </label>
              <div className="label">
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                ...
                <input
                  ...
                  onChange={(e) => saveConfig('close_to_tray', e.target.checked)}
                  disabled={saving}
                />
              </label>
              <div className="label">
      ...
      <div className="card bg-base-200">
        <div className="card-body">
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              <label className="label cursor-pointer">
                <span className="label-text text-lg">Start with sidebar collapsed</span>
                <input
                  type="checkbox"
                  className="toggle toggle-primary"
                  checked={config.sidebar_collapsed || false}
                  onChange={(e) => saveConfig('sidebar_collapsed', e.target.checked)}
                  disabled={saving}
                />
              </label>
              <div className="label">
