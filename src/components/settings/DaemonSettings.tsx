  ...
  const loadData = async () => {
    try {
      ...
      const [daemonConfig, daemonStatus] = await Promise.all([
        ...
        window.API_RENDERER.goDaemon.getDaemonStatus().catch(() => ({ running: false }))
      ]);
      ...
      setError(err instanceof Error ? err.message : 'Failed to load daemon information');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="card-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className={`badge badge-lg ${status.running ? 'badge-success' : 'badge-error'}`}>
          ...
          <div className="card-actions justify-end mt-4">
            ...
            <button
              ...
              onClick={() => handleDaemonAction(status.running ? 'stop' : 'start')}
              disabled={saving}
            >
              {status.running ? (
                <>
          ...
          <div className="space-y-4">
            ...
            <div className="form-control">
              ...
              <div className="join w-full">
                <input
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, socket_path: e.target.value }))}
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setConfig(prev => ({ ...prev, max_connections: parseInt(e.target.value) }))}
                min="1"
                max="100"
                disabled={saving}
              />
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-lg">Heartbeat interval (ms)</span>
              </label>
              <input
                type="number"
                className="input input-bordered w-full max-w-xs"
                value={config.heartbeat_interval || 5000}
                onChange={(e) => setConfig(prev => ({ ...prev, heartbeat_interval: parseInt(e.target.value) }))}
                min="1000"
                max="60000"
                step="1000"
                disabled={saving}
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text text-lg">Connection timeout (ms)</span>
              </label>
              <input
                type="number"
                className="input input-bordered w-full max-w-xs"
