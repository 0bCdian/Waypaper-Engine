	...
	return (
		<header className={headerClasses} {...props}>
			...
			<div className="navbar-end gap-2">
				{/* Theme toggle */}
				{showThemeToggle && <ThemeToggle showLabel={false} />}
...
export interface CompactHeaderProps
	extends Omit<HeaderProps, "showThemeSelector" | "showThemeToggle"> {
	/** Whether to show theme toggle */
	showThemeToggle?: boolean;
}
...
export const FullHeader: React.FC<HeaderProps> = (props) => {
	return <Header showThemeSelector={true} showThemeToggle={false} {...props} />;
};
