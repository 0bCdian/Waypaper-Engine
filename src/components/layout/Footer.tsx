		...
		<footer className={footerClasses} {...props}>
			<div className="flex items-center justify-between w-full">
				...
				<div className="flex items-center gap-4">
					{showCopyright && (
						<p className="text-sm text-base-content/70">{copyrightText}</p>
					)}
				</div>
...
export const FooterDivider: React.FC<FooterDividerProps> = ({
	...
	const dividerClasses = cn("w-px h-4 bg-base-300", className);
...
export const FooterGroup: React.FC<FooterGroupProps> = ({
	...
	const groupClasses = cn("footer-group", className);
