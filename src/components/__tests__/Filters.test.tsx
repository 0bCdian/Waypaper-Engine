...
const mockImagesState = {
	...
	filters: {
		...
		searchString: "",
		tags: [],
		advancedFilters: { formats: [], resolution: { constraint: "all" as const, width: 0, height: 0 }, colors: [] },
	},
};
...
beforeEach(() => {
	vi.clearAllMocks();
	(window.API_RENDERER.goDaemon.getImageTags as ReturnType<typeof vi.fn>).mockResolvedValue({ tags: [] });
});
