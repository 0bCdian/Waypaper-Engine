      ...
      return (
        ...
        >
          {thumbSrc ? (
            ...
            <div className="size-20 bg-base-200 flex items-center justify-center text-xs">
              Image
            </div>
          )}
        </div>
      ...
      <div className="relative" style={{ width: 100, height: 80 }}>
        ...
        >
          {thumbSrc ? (
            ...
            <div className="size-16 bg-base-200" />
          )}
        </div>
        <div
          className="absolute -top-2 -right-2 flex size-6 items-center justify-center rounded-full bg-primary text-primary-content text-xs font-bold shadow-md"
          style={{ zIndex: 10 }}
        >
          {count}
        </div>
