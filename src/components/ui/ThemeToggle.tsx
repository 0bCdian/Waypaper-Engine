 ...
 */
export const CompactThemeToggle: React.FC<Omit<ThemeToggleProps, 'showLabel'>> = (props) => {
 ...
 */
export const FullThemeToggle: React.FC<Omit<ThemeToggleProps, 'showLabel'>> = (props) => {
