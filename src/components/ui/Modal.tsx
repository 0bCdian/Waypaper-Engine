...
export const Modal = forwardRef<HTMLDivElement, ModalProps>(
	(
		...
		// Modal classes
		const modalClasses = cn("modal-box relative", sizeClasses[size], className);

		// Backdrop classes
		const backdropClasses = cn("modal-backdrop", open ? "modal-open" : "");
...
export const ModalBody = forwardRef<HTMLDivElement, ModalBodyProps>(
	({ className, children, ...props }, ref) => {
		const bodyClasses = cn("modal-body py-4", className);
