      ...
      <div className="modal-box max-w-lg">
        ...
        <div className="py-4 space-y-3 text-sm text-base-content/80">
          <p>
            ...
            third-party service that is not operated, controlled, or audited by the developer of
            this application.
          </p>
          ...
          <ul className="list-disc list-inside space-y-1.5 pl-1">
            ...
            <li>
              Wallhaven hosts <strong>user-uploaded content</strong> including NSFW material.
              Content safety is not guaranteed even with purity filters enabled.
            </li>
            <li>
            ...
            <li>
              Standard internet risks apply: your network traffic may be visible to your ISP,
              network administrator, or Wallhaven itself, and downloaded files could theoretically
              be malicious.
            </li>
          </ul>
