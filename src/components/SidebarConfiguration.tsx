    ...
    <div className="space-y-4">
      <div className="form-control">
        ...
        <input
          ...
          onChange={(e) => saveConfigSection("app", { start_minimized: e.target.checked })}
        />
      </div>
      ...
      <div className="form-control">
        <label htmlFor="app-kill-daemon-on-exit" className="label">
          <span className="label-text text-sm font-medium">Kill Daemon on Exit</span>
        </label>
        <input
          ...
          onChange={(e) => saveConfigSection("app", { kill_daemon_on_exit: e.target.checked })}
        />
      </div>
    </div>
  );
    ...
    <div className="space-y-4">
      <div className="form-control">
        ...
        <select
          ...
          onChange={(e) => saveConfigSection("daemon", { log_level: e.target.value })}
        >
