...
const LoadPlaylistModal = ({ playlistsInDB, onPlaylistChanged, currentPlaylistName }: Props) => {
  ...
  return (
    ...
    >
      <h2 className="select-none py-3 text-center text-4xl font-bold">Load Playlist</h2>
      {error.length > 0 && (
      ...
      {playlistsInDB && playlistsInDB.length > 0 && (
        ...
        >
          ...
          <div className="mt-3 flex justify-center gap-3">
            <button type="button" className="btn btn-md rounded-md uppercase" onClick={closeModal}>
              Cancel
            </button>
