...
function PaginatedGallery() {
    ...
    const updateImagesPerPage = debounce(() => {
        ...
        const newImagesPerPage = Math.ceil(coeficient * newDimensions.height * newDimensions.width);
    ...
    const imagesToShow = useMemo(
        function () {
            const imagesToShow = [...SkeletonsArray, ...imagesCardArray].slice(firstImageIndex, lastImageIndex);
            return imagesToShow;
        },
