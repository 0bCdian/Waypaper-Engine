 ...
 */
const daisyUIThemeMetadata: Record<
	string,
	{
		displayName: string;
		description: string;
...
> = {
	...
	bumblebee: {
		...
		description: "Bright yellow and black theme",
		category: "light",
	},
	emerald: {
		displayName: "Emerald",
	...
	retro: {
		displayName: "Retro",
		description: "Vintage-inspired theme",
		category: "mixed",
	},
	cyberpunk: {
	...
	wireframe: {
		...
		description: "Minimalist outline-solid theme",
		category: "light",
	},
	black: {
		displayName: "Black",
	...
	cmyk: {
		displayName: "CMYK",
		description: "Print-inspired color theme",
		category: "light",
	},
	autumn: {
		displayName: "Autumn",
	...
	lemonade: {
		...
		description: "Fresh citrus theme",
		category: "light",
	},
	night: {
		displayName: "Night",
 ...
 */
const customThemeMetadata: Record<
	string,
	{
		displayName: string;
		description: string;
...
> = {
	...
	everforest: {
		...
		description: "Low contrast, greenish dark theme",
		category: "dark",
	},
	"gruvbox-material": {
		displayName: "Gruvbox Material",
		description: "Material Design version of Gruvbox",
		category: "dark",
	},
	"gruvbox-light": {
		displayName: "Gruvbox Light",
		description: "Light version of retro groove colors",
		category: "light",
	},
	"catppuccin-light": {
		displayName: "Catppuccin Light",
		description: "Light version of soothing pastel theme",
		category: "light",
	},
	"monokai-light": {
		displayName: "Monokai Light",
		description: "Light version of classic monokai",
		category: "light",
	},
	"tokyo-night-light": {
		displayName: "Tokyo Day",
		description: "Light version inspired by Tokyo",
		category: "light",
	},
	"everforest-light": {
		displayName: "Everforest Light",
		description: "Light version with greenish tones",
		category: "light",
	},
	"gruvbox-material-light": {
...
function createDaisyUITheme(name: string): ThemeConfig {
	...
	return {
		name,
		displayName:
			metadata?.displayName || name.charAt(0).toUpperCase() + name.slice(1),
