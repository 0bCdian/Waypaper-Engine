...
export function isImageProcessedPayload(
	payload: unknown,
): payload is DaemonImageProcessedPayload {
	return (
...
export function isImageErrorPayload(
	payload: unknown,
): payload is DaemonImageErrorPayload {
	return (
		typeof payload === "object" &&
		payload !== null &&
		"originalFileName" in payload &&
...
export function isProcessingCompletePayload(
	payload: unknown,
): payload is DaemonProcessingCompletePayload {
	return (
		typeof payload === "object" &&
		payload !== null &&
...
export function isImagesUpdatedPayload(
	payload: unknown,
): payload is DaemonImagesUpdatedPayload {
	return (
		typeof payload === "object" &&
		payload !== null &&
		"action" in payload &&
...
export function isThumbnailCreatedPayload(
	payload: unknown,
): payload is DaemonThumbnailCreatedPayload {
	return (
		typeof payload === "object" &&
		payload !== null &&
