...
var Playlist = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        imageLocation = (0, node_path_1.join)(config_1.default.IMAGES_DIR, imageName);
                        command = this.getSwwwCommandFromConfiguration(imageLocation);
                        (0, notifications_1.notifyImageSet)(imageName, imageLocation);
                        return [4 /*yield*/, execPromisified(command)];
                    case 1:
                        _a.sent();
                        if (!(config_1.default.script !== undefined)) return [3 /*break*/, 3];
                        return [4 /*yield*/, execPromisified("".concat(config_1.default.script, " ").concat(imageLocation))];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                ...
                switch (_a.label) {
                    case 0:
                        if (this.currentType === daemonTypes_1.PLAYLIST_TYPES.DAY_OF_WEEK ||
                            ...
                            return [2 /*return*/, 'Cannot change image in this type of playlist'];
                        }
    ...
    Playlist.prototype.neverPlaylist = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setImage(this.images[this.currentImageIndex].name)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        millisecondsUntilEndOfDay = endOfDay.getTime() - now.getTime();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        images = dbOperationsDaemon_1.default.readAllImagesInDB();
                        if (images === undefined) {
                            return [2 /*return*/, 'There are no images in the database'];
                        }
